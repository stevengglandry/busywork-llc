...
- **Finish and review:** Completion consumes every supplied resource and leaves the employee in In Progress for reassignment. The finished work product enters Review without changing the player's current selection.
